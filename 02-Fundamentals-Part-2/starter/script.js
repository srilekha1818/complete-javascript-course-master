...
let scoreDolphins1 = calcAvg(44, 23, 71);
let scoreKoalas1 = calcAvg(65, 54, 49);
console.log(scoreDolphins1, scoreKoalas1);
const checkWinner = (avgDolphins, avgKoalas) => {
  if (avgDolphins > avgKoalas * 2)
    console.log(`dolphin wins with ${avgDolphins} vs ${avgKoalas}`);
  else if (avgKoalas > avgDolphins * 2)
    console.log(`koalas wins with ${avgKoalas} vs ${avgDolphins}`);
  else console.log(`no one wins`);
};
checkWinner(576, 111);
scoreDolphins1 = calcAvg(85, 54, 41);
scoreKoalas1 = calcAvg(23, 34, 27);
console.log(scoreDolphins1, scoreKoalas1);
...
console.log(jonas_2.lastName);
console.log(jonas_2["lastName"]);

const nameKey = "Name";
console.log(jonas_2["first" + nameKey]);
console.log(jonas_2["last" + nameKey]);
...
console.log(
  `${jonas_2.firstName} has ${jonas_2.friends.length} friends, and his best friend is called ${jonas_2.friends[0]}`
);
...
console.log(jonas_a.calcAge());

console.log(jonas_a.age);
console.log(jonas_a.age);
console.log(jonas_a.age);

// Challenge
// "Jonas is a 46-year old teacher, and he has a driver's license"
console.log(jonas_a.getSummary());
/*
...
for (let i = 0; i < jonas_b.length; i++) {
  // Reading from jonas array
  console.log(jonas_b[i], typeof jonas[i]);

  // Filling types array
  // types[i] = typeof jonas[i];
  types.push(typeof jonas_b[i]);
}

console.log(types);

const years_a = [1991, 2007, 1969, 2020];
const ages_a = [];

for (let i = 0; i < years.length; i++) {
  ages.push(2037 - years_a[i]);
}
console.log(ages_a);
...
for (let i = 0; i < jonas_b.length; i++) {
  if (typeof jonas_b[i] !== "string") continue;
...
for (let i = 0; i < jonas_b.length; i++) {
  if (typeof jonas_b[i] === "number") break;

  console.log(jonas_b[i], typeof jonas_b[i]);
}
...
for (let i = jonas_c.length - 1; i >= 0; i--) {
  console.log(i, jonas_c[i]);
}
